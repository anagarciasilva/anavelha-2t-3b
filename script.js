...
const perguntas = [
    ...
    {
        enunciado: "Você considera alguma  amizade igual a amizade do Patrick com o Bob esponja?",
        alternativas: [
            {
                texto: "não, acho a amizade desles estranha!",
                afirmacao: "Conseguiu utilizar a IA para buscar informações úteis."
            },
            {
                texto: "sim, adoro a sincronização deles!",
